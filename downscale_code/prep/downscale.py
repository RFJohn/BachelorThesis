...
def clamp_batch4_index(index, index_count):
    ...
    if index + 4 <= index_count - 1:
        return index, index + 1, index + 2, index + 3, index + 4
    else:
        i0 = clamp_upper_index(index, index_count)
        i1 = clamp_upper_index(index + 1, index_count)
        i2 = clamp_upper_index(index + 2, index_count)
        i3 = clamp_upper_index(index + 3, index_count)
        i4 = clamp_upper_index(index + 4, index_count)
